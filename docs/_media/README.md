...
## Documentation
Detailed API documentation is available in the [docs](_media/README.md) directory. This documentation is automatically generated using TypeDoc and includes:
- API Reference
